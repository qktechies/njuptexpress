...
.controller('memberExpressCtrl', ['$scope', '$rootScope', 'AdminUser', '$state','$cookies', 'MemberExpress', 'pageSize', function ($scope, $rootScope, AdminUser, $state, $cookies, MemberExpress, pageSize) {
    ...
    $scope.getExpresses = function() {
        ...
        MemberExpress.get(pageSize, skip, function (status, data) {
            switch (status) {
                case 0:
